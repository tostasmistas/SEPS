...
É ainda pretendido que seja gerada uma outra saída em quadratura, ou seja, um coseno. Para a sua implementação baseou-se na seguinte figura:
 ...
 que é possível lendo a LUT com um \textit{offset} de 16 valores. É apresentado o excerto de código que implementa o oscilador, permitindo que sejam geradas as duas saídas em quadratura.
