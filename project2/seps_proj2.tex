...
A primeira componente corresponde à envolvente do sinal de entrada do filtro e a segunda componente corresponde às oscilações que se visualizam no sinal a amarelo.  A função do filtro de dados é retirar as oscilações do sinal de entrada obtendo assim a sua envolvente, conclusão que pode ser visualizada na Figura 39.
