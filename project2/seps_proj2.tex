...
\todo{seno e coseno em quadratura}
...
\begin{figure}[H]
	...
	\caption{Sinal de entrada(verde) e sinal de saída(amarelo) do filtro de dados.}
	\vspace{-0.8em}
\end{figure} 
...
\begin{figure}[H]
	...
	\caption{Sinal à saída do filtro \textit{data} com o \textit{Costas Loop} completo.}
	\vspace{-0.8em}
\end{figure}
