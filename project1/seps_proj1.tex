...
Pode-se agora computar \textit{y} de acordo com a equação (\ref{eq:interpol}). Quando se faz a subtracção entre \texttt{y2} ($Q_{15}$) e \texttt{y1} ($Q_{15}$), o resultado fica no formato $Q_{14}$ que quando é multiplicado com \texttt{delta\_x} 
