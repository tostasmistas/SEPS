...
Com o modulador criado procede-se à fase de testes. Sabe-se que o sinal modulado do tipo BPSK,$d_n$, tem uma frequência de 500 \textit{Hz} com um ritmo de transmissão de 1 \textit{kbps} modulado por uma portadora de 4 kHz. Assim, existe uma inversão de fase a cada  4000/500  = 8 ciclos. \todo{nao se percebe porquê - teddy}
